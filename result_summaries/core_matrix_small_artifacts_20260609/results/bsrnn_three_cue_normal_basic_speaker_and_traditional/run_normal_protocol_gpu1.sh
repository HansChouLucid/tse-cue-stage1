...
run_one tfmap_ft13 examples/audio/librimix/confs/tse_bsrnn_spk_tfmap_train100_ft13_from5.yaml /data/tse_cue_project/experiments/normal_basic_single_cue/tfmap_only_bsrnn_normal_train100_ft13_from5_dualA100_ddp2/models/final_checkpoint.pt "$OUT_ROOT/tfmap_ft13"
