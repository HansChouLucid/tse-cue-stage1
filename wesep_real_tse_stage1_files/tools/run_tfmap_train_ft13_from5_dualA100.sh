...
torchrun --standalone --nnodes=1 --nproc_per_node=2 \
  wesep/bin/train.py \
  --config examples/audio/librimix/confs/tse_bsrnn_spk_tfmap_train100_ft13_from5.yaml \
  --exp_dir /data/tse_cue_project/experiments/normal_basic_single_cue/tfmap_only_bsrnn_normal_train100_ft13_from5_dualA100_ddp2 \
  --gpus '[0,1]' \
  --num_avg 1 \
  --data_type raw \
